...
#         product_1 = Product.objects.create(title='Product_1', category=category, image=uploaded, slug='product_1')
#         product_2 = Product.objects.create(title='Product_2', category=category, image=uploaded, slug='product_2')
...
#         self.product = ProductProxy.objects.create(title='Test Product', category=self.category, image=uploaded, slug='test-product')
